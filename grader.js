...
references:
	+cheerio
		-https://github.com/matthewMueller/cherio
		-https://encosia.com/cheerio-faster-windows-friendly-alternative-jsdom/
		-htp://maxogden.com/scraping-with-node.html
	...
	+ JSON
		...
		-https://developer.mozzila.org/en-US/docs/JSON
...
if(require.main == module) {
	program
		...
		.option('-u, --url <url>', 'shielded-ocean-7490.herokuapp.com', clone(assertFileExists), URL_DEFAULT)
		.parse(process.argv);
